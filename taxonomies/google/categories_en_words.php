...
$categories = [
	'Animals & Pet Supplies'    => [
		...
		'Pet Supplies' => [
			'Bird Supplies'                => [
				'Bird Cage Accessories' => [ 'Bird Cage Bird Baths', 'Bird Cage Food & Water Dishes' ],
				'Bird Cages & Stands',
				'Bird Food',
				'Bird Gyms & Playstands',
				'Bird Ladders & Perches',
				'Bird Toys',
				'Bird Treats'
			],
			'Cat Supplies'                 => [
			...
			'Pet Sunscreen',
			'Pet Training Aids'            => [
				'Pet Training Clickers & Treat Dispensers',
			...
			'Reptile & Amphibian Supplies' => [
				...
				'Reptile & Amphibian Habitat Accessories',
				'Reptile & Amphibian Habitat Heating & Lighting',
	...
	'Apparel & Accessories'     => [
		'Clothing'                     => [
			'Activewear'                        => [
				...
				'Hunting Clothing'               => [
					'Ghillie Suits',
					'Hunting & Fishing Vests',
					'Hunting & Tactical Pants'
				],
				'Martial Arts Shorts',
			...
			'Suits'                             => [ 'Pant Suits', 'Skirt Suits', 'Tuxedos' ],
			'Swimwear',
			'Traditional & Ceremonial Clothing' => [
				...
				'Kimono Outerwear',
				'Kimonos',
				'Religious Ceremonial Clothing' => [ 'Baptism & Communion Dresses' ],
				'Saris & Lehengas',
			...
			'Wedding & Bridal Party Dresses'    => [ 'Bridal Party Dresses', 'Wedding Dresses' ]
		],
		'Clothing Accessories'         => [
			...
			'Balaclavas',
			'Bandanas & Headties'                 => [ 'Bandanas', 'Hair Care Wraps' ],
			'Belt Buckles',
			'Belts',
			'Bridal Accessories'                  => [ 'Bridal Veils' ],
			'Button Studs',
			'Collar Stays',
			'Cufflinks',
			'Decorative Fans',
			...
			'Handkerchiefs',
			'Hats',
			'Headwear'                            => [ 'Fascinators', 'Headdresses', 'Turbans' ],
			'Leg Warmers',
			'Leis',
			...
			'Suspenders',
			'Tie Clips',
			'Traditional Clothing Accessories'    => [ 'Obis', 'Tabi Socks' ],
			'Wristbands'
		],
	...
	'Arts & Entertainment'      => [
		...
		'Hobbies & Creative Arts' => [
			'Arts & Crafts'                              => [
				...
				'Art & Crafting Tools'            => [
					'Blocking Mats',
					'Blocking Wires',
					'Color Mixing Tools'              => [ 'Palette Knives', 'Palettes' ],
					...
					'Thimbles & Sewing Palms'         => [ 'Sewing Palms', 'Thimbles' ],
					'Thread & Yarn Tools'             => [
						'Fiber Cards & Brushes',
						'Hand Spindles',
						'Needle Threaders',
			...
			'Collectibles'                               => [
				'Autographs',
				'Collectible Coins & Currency' => [ 'Collectible Banknotes', 'Collectible Coins' ],
				...
				'Sports Collectibles'          => [
					'Autographed Sports Paraphernalia' => [
						...
						'Baseball & Softball Autographed Paraphernalia',
			...
			'Musical Instrument & Orchestra Accessories' => [
				...
				'Musical Instrument Amplifier Accessories' => [
					...
					'Musical Instrument Amplifier Covers & Cases',
				...
				'Percussion Accessories'                   => [
					...
					'Drum Stick & Brush Accessories' => [ 'Drum Stick & Brush Bags & Holders' ],
					'Drum Sticks & Brushes',
					'Electronic Drum Modules',
					'Hand Percussion Accessories'    => [
						'Hand Percussion Bags & Cases',
						'Hand Percussion Stands & Mounts'
					],
					'Percussion Mallets',
					'Percussion Stands'
				],
				'String Instrument Accessories'            => [
					...
					'String Instrument Care & Cleaning'        => [
						'Bow Rosin',
				...
				'Woodwind Instrument Accessories'          => [
					'Bassoon Accessories'             => [
						'Bassoon Care & Cleaning' => [ 'Bassoon Swabs' ],
						'Bassoon Cases & Gigbags',
						'Bassoon Parts'           => [
							'Bassoon Bocals',
							'Bassoon Small Parts'
						],
					...
					'Clarinet Accessories'            => [
						...
						'Clarinet Cases & Gigbags',
						'Clarinet Ligatures & Caps',
						'Clarinet Parts'           => [
							'Clarinet Barrels',
							'Clarinet Bells',
						...
						'Clarinet Pegs & Stands',
						'Clarinet Reeds',
						'Clarinet Straps & Supports'
					],
					'Flute Accessories'               => [
						'Flute Care & Cleaning' => [
							'Flute Care Kits',
					...
					'Harmonica Accessories'           => [ 'Harmonica Cases', 'Harmonica Holders' ],
					'Oboe & English Horn Accessories' => [
						'Oboe Care & Cleaning' => [
							'Oboe Care Kits',
							'Oboe Swabs'
						],
						'Oboe Cases & Gigbags',
						'Oboe Parts'           => [ 'Oboe Small Parts' ],
						'Oboe Pegs & Stands',
						'Oboe Reeds',
						'Oboe Straps & Supports'
					],
					'Recorder Accessories'            => [
						'Recorder Care & Cleaning',
						'Recorder Cases',
						'Recorder Parts'
					],
					'Saxophone Accessories'           => [
						'Saxophone Care & Cleaning' => [
							'Saxophone Care Kits',
							'Saxophone Pad Savers',
							'Saxophone Swabs'
						],
						'Saxophone Cases & Gigbags',
						'Saxophone Ligatures & Caps',
						'Saxophone Parts'           => [
							'Saxophone Mouthpieces',
							'Saxophone Necks',
							'Saxophone Small Parts'
						],
						'Saxophone Pegs & Stands',
						'Saxophone Reeds',
						'Saxophone Straps & Supports'
					],
		...
		'Party & Celebration'     => [
			...
			'Party Supplies'    => [
				...
				'Confetti',
				'Decorative Pom-Poms',
				'Drinking Games' => [ 'Beer Pong' => [ 'Beer Pong Tables' ] ],
				...
				'Invitations',
				'Noisemakers & Party Blowers',
				'Party Favors'   => [ 'Wedding Favors' ],
				'Party Games',
				'Party Hats',
	...
	'Baby & Toddler'            => [
		'Baby Bathing'                   => [ 'Baby Bathtubs & Bath Seats', 'Shower Visors' ],
		'Baby Gift Sets',
		'Baby Health'                    => [
		...
		'Baby Toys & Activity Equipment' => [
			...
			'Play Mats & Gyms' => [ 'Play Gyms', 'Play Mats' ],
			'Play Yards',
			'Push & Pull Toys',
			'Rattles',
		...
		'Potty Training'                 => [ 'Potty Seats', 'Potty Training Kits' ],
		'Swaddling & Receiving Blankets' => [ 'Receiving Blankets', 'Swaddling Blankets' ]
	],
	'Business & Industrial'     => [
		...
		'Construction'                  => [ 'Surveying', 'Traffic Cones & Barrels' ],
		'Dentistry'                     => [
			'Dental Cement',
			'Dental Tools' => [
				'Dappen Dishes',
		...
		'Food Service'                  => [
			...
			'Disposable Lids',
			'Disposable Serveware' => [ 'Disposable Serving Trays' ],
		...
		'Hairdressing & Cosmetology'    => [
			'Hairdressing Capes & Neck Covers',
			'Pedicure Chairs',
			'Salon Chairs'
		],
		...
		'Industrial Storage'            => [
			...
			'Industrial Shelving',
			'Shipping Containers',
			'Wire Partitions, Enclosures & Doors'
		],
		'Industrial Storage Accessories',
		'Janitorial Carts & Caddies',
		'Law Enforcement'               => [ 'Cuffs', 'Metal Detectors' ],
		'Manufacturing',
		'Material Handling'             => [
			'Conveyors',
			'Lifts & Hoists' => [
				'Hoists, Cranes & Trolleys',
				'Jacks & Lift Trucks',
				'Personnel Lifts',
				'Pulleys, Blocks & Sheaves',
				'Winches'
			],
		...
		'Medical'                       => [
			...
			'Medical Equipment'          => [
				...
				'Gait Belts',
				'Medical Reflex Hammers & Tuning Forks',
			...
			'Medical Furniture'          => [
				...
				'Medical Cabinets',
				'Medical Carts' => [ 'Crash Carts', 'IV Poles & Carts' ],
				'Surgical Tables'
			],
			'Medical Instruments'        => [
				'Medical Forceps',
			...
			'Medical Teaching Equipment' => [ 'Medical & Emergency Response Training Mannequins' ],
			'Scrub Caps',
			'Scrubs',
			'Surgical Gowns'
		],
		'Mining & Quarrying',
		'Piercing & Tattooing'          => [
			'Piercing Supplies'  => [ 'Piercing Needles' ],
			'Tattooing Supplies' => [
				'Tattoo Cover-Ups',
				'Tattooing Inks',
				'Tattooing Machines',
		...
		'Retail'                        => [
			...
			'Money Handling' => [
				'Banknote Verifiers',
				'Cash Register & POS Terminal Accessories' => [
					'Cash Drawers & Trays',
				...
				'Money Changers',
				'Money Deposit Bags',
				'Paper Coin Wrappers & Bill Straps'
			],
			'Paper & Plastic Shopping Bags',
			'Pricing Guns',
			'Retail Display Cases',
			'Retail Display Props & Models'
		],
		'Science & Laboratory'          => [
			'Biochemicals',
			'Dissection Kits',
		...
		'Work Safety Protective Gear'   => [
			'Bullet Proof Vests',
			'Gas Mask & Respirator Accessories',
			'Hardhats',
	...
	'Cameras & Optics'          => [
		'Camera & Optic Accessories' => [
			...
			'Camera Parts & Accessories'   => [
				...
				'Camera Bags & Cases',
				'Camera Body Replacement Panels & Doors',
				...
				'Camera Replacement Buttons & Knobs',
				'Camera Replacement Screens & Displays',
				'Camera Silencers & Sound Blimps',
				'Camera Stabilizers & Supports',
				'Camera Straps',
				'Camera Sun Hoods & Viewfinder Attachments',
				'Flash Brackets',
				'On-Camera Monitors',
			...
			'Optic Accessories'            => [
				'Binocular & Monocular Accessories',
				'Optics Bags & Cases',
		...
		'Photography'                => [
			'Darkroom'          => [
				'Developing & Processing Equipment' => [
					...
					'Print Trays, Washers & Dryers',
					'Retouching Equipment & Supplies'
				],
				'Enlarging Equipment'               => [
					'Darkroom Easels',
					'Darkroom Timers',
	...
	'Electronics'               => [
		...
		'Audio'                          => [
			'Audio Accessories'         => [
				...
				'Headphone & Headset Accessories' => [ 'Headphone Cushions & Tips' ],
				'Karaoke System Accessories'      => [ 'Karaoke Chips' ],
				...
				'Speaker Accessories'             => [
					'Speaker Bags, Covers & Cases',
					'Speaker Components & Kits',
					'Speaker Stand Bags',
			...
			'Audio Players & Recorders' => [
				...
				'Radios',
				'Reel-to-Reel Tape Players & Recorders',
				'Stereo Systems',
				'Turntables & Record Players',
				'Voice Recorders'
			],
			'Bullhorns',
			'DJ & Specialty Audio'      => [ 'DJ CD Players', 'DJ Systems' ],
			'Public Address Systems',
			'Stage Equipment'           => [ 'Wireless Transmitters' ]
		],
		'Circuit Boards & Components'    => [
			'Circuit Board Accessories',
			'Circuit Decoders & Encoders',
			'Circuit Prototyping'        => [ 'Breadboards' ],
			'Electronic Filters',
			...
			'Printed Circuit Boards'     => [
				...
				'Pool & Spa Circuit Boards',
				'Printer, Copier, & Fax Machine Circuit Boards',
		...
		'Communications'                 => [
			...
			'Telephony'            => [
				...
				'Mobile Phone Accessories' => [
					...
					'Mobile Phone Pre-Paid Cards & SIM Cards' => [
				...
				'Satellite Phones',
				'Telephone Accessories'    => [ 'Phone Cards' ]
			],
			'Video Conferencing'
		],
		'Components'                     => [
		...
		'Electronics Accessories'        => [
			...
			'Audio & Video Splitters & Switches' => [
				'DVI Splitters & Switches',
				'HDMI Splitters & Switches',
				'VGA Splitters & Switches'
			],
			'Blank Media',
			'Cable Management'                   => [
				'Cable Clips',
				...
				'Cable Trays',
				'Patch Panels',
				'Wire & Cable Identification Markers',
				'Wire & Cable Sleeves',
				'Wire & Cable Ties'
			],
			'Cables'                             => [
			...
			'Computer Accessories'               => [
				...
				'Handheld Device Accessories' => [
					'E-Book Reader Accessories' => [ 'E-Book Reader Cases' ],
					'PDA Accessories'           => [ 'PDA Cases' ]
				],
				'Keyboard & Mouse Wrist Rests',
				'Keyboard Trays & Platforms',
				'Laptop Docking Stations',
				'Mouse Pads',
				'Stylus Pen Nibs & Refills',
				'Stylus Pens',
			...
			'Computer Components'                => [
				...
				'Desktop Computer & Server Cases',
				'E-Book Reader Parts'      => [ 'E-Book Reader Screens & Screen Digitizers' ],
				'I/O Cards & Adapters'     => [
					'Audio Cards & Adapters',
					'Computer Interface Cards & Adapters',
					'Riser Cards',
				...
				'Input Devices'            => [
					...
					'Game Controllers' => [
						...
						'Musical Instrument Game Controllers'
					],
				...
				'Tablet Computer Parts'    => [
					'Tablet Computer Housings & Trim',
					'Tablet Computer Replacement Speakers',
					'Tablet Computer Screens & Screen Digitizers'
				],
				'USB & FireWire Hubs'
			],
			'Electronics Cleaners',
			'Electronics Films & Shields'        => [
				'Electronics Stickers & Decals',
				'Keyboard Protectors',
				'Privacy Filters',
				'Screen Protectors'
			],
			...
			'Memory Accessories'                 => [ 'Memory Cases' ],
			'Mobile Phone & Tablet Tripods & Monopods',
			'Power'                              => [
				'Batteries'           => [
					'Camera Batteries',
				...
				'Fuel Cells',
				'Power Adapter & Charger Accessories',
		...
		'GPS Accessories'                => [ 'GPS Cases', 'GPS Mounts' ],
		...
		'Print, Copy, Scan & Fax'        => [
			...
			'Printer, Copier & Fax Machine Accessories' => [
				...
				'Printer Memory',
				'Printer Stands',
				'Printer, Copier & Fax Machine Replacement Parts'
			],
		...
		'Video'                          => [
			...
			'Video Accessories'         => [
				'3D Glasses',
				'Computer Monitor Accessories'   => [ 'Color Calibrators' ],
				'Projector Accessories'          => [
					'Projection & Tripod Skirts',
	...
	'Furniture'                 => [
		...
		'Cabinets & Storage'            => [
			...
			'Storage Chests' => [ 'Hope Chests', 'Toy Chests' ],
			'Vanities'       => [
				'Bathroom Vanities',
				'Bedroom Vanities'
			],
		...
		'Carts & Islands'               => [ 'Kitchen & Dining Carts', 'Kitchen Islands' ],
		...
		'Outdoor Furniture Accessories' => [ 'Outdoor Furniture Covers' ],
		'Room Divider Accessories',
		'Room Dividers',
		'Shelving'                      => [ 'Bookcases & Standing Shelves', 'Wall Shelves & Ledges' ],
		'Shelving Accessories'          => [ 'Replacement Shelves' ],
		'Sofa Accessories'              => [ 'Chair & Sofa Supports', 'Sectional Sofa Units' ],
		'Sofas',
		'Table Accessories'             => [ 'Table Legs', 'Table Tops' ],
		'Tables'                        => [
			'Accent Tables' => [
				'Coffee Tables',
				'End Tables',
	...
	'Hardware'                  => [
		'Building Consumables'                    => [
			'Chemicals'            => [
				...
				'Lighter Fluid',
				'Septic Tank & Cesspool Treatments'
			],
		...
		'Fuel'                                    => [
			'Home Heating Oil',
			'Kerosene' => [ 'Clear Kerosene', 'Dyed Kerosene' ],
			'Propane'
		],
		'Fuel Containers & Tanks',
		'Hardware Accessories'                    => [
			'Brackets & Reinforcement Braces',
			'Cabinet Hardware'            => [
				'Cabinet & Furniture Keyhole Escutcheons',
				'Cabinet Backplates',
				'Cabinet Catches',
				'Cabinet Doors',
			...
			'Lubrication Hoses',
			'Metal Casting Molds',
			'Moving & Soundproofing Blankets & Covers',
			'Pneumatic Hoses',
			'Post Base Plates',
			'Springs',
			'Tarps',
		...
		'Hardware Pumps'                          => [
			...
			'Sprinkler, Booster & Irrigation System Pumps',
		...
		'Plumbing'                                => [
			'Plumbing Fittings & Supports'      => [
				'Gaskets & O-Rings',
				'In-Wall Carriers & Mounting Frames',
				'Nozzles',
				'Pipe Adapters & Bushings',
				'Pipe Caps & Plugs',
				'Pipe Connectors',
				'Plumbing Flanges',
		...
		'Storage Tanks',
		'Tool Accessories'                        => [
			'Abrasive Blaster Accessories'        => [ 'Sandblasting Cabinets' ],
			'Axe Accessories'                     => [ 'Axe Handles', 'Axe Heads' ],
			'Cutter Accessories'                  => [ 'Nibbler Dies' ],
			...
			'Grinder Accessories'                 => [ 'Grinding Wheels & Points' ],
			'Hammer Accessories'                  => [
			...
			'Mattock & Pickaxe Accessories'       => [ 'Mattock & Pickaxe Handles' ],
			...
			'Power Tool Chargers',
			'Router Accessories'                  => [ 'Router Bits', 'Router Tables' ],
			'Sanding Accessories'                 => [ 'Sandpaper & Sanding Sponges' ],
			'Saw Accessories'                     => [
			...
			'Shaper Accessories'                  => [ 'Shaper Cutters' ],
			'Soldering Iron Accessories'          => [ 'Soldering Iron Stands', 'Soldering Iron Tips' ],
			'Tool Blades'                         => [ 'Cutter & Scraper Blades', 'Saw Blades' ],
			'Tool Handle Wedges',
			'Tool Safety Tethers',
			'Tool Sockets',
			'Tool Stands'                         => [ 'Saw Stands' ],
			'Wedge Tools',
			'Welding Accessories'
		],
		'Tools'                                   => [
			...
			'Flashlights & Headlamps'   => [ 'Flashlights', 'Headlamps' ],
			'Grease Guns',
			'Grinders',
			'Grips',
			'Hammers'                   => [ 'Manual Hammers', 'Powered Hammers' ],
			...
			'Reamers',
			'Riveting Tools'            => [ 'Rivet Guns', 'Rivet Pliers' ],
			'Routing Tools',
			'Sanders',
			'Sanding Blocks',
			'Saw Horses',
			...
			'Tool Keys',
			'Tool Knives',
			'Tool Sets'                 => [ 'Hand Tool Sets', 'Power Tool Combo Sets' ],
			'Welding Guns & Plasma Cutters',
			'Wire & Cable Hand Tools',
			'Work Lights',
			'Wrenches'
		]
	],
	'Health & Beauty'           => [
		'Health Care'             => [
			'Acupuncture'                               => [ 'Acupuncture Models', 'Acupuncture Needles' ],
			'Bed Pans',
			'Biometric Monitor Accessories'             => [
				...
				'Blood Pressure Monitor Accessories' => [ 'Blood Pressure Monitor Cuffs' ],
			...
			'Medical Identification Tags & Jewelry',
			'Medical Tests'                             => [
				'Allergy Test Kits',
		...
		'Personal Care'           => [
			'Back Care'                   => [ 'Back & Lumbar Support Cushions' ],
			'Cosmetics'                   => [
				'Bath & Body'    => [
				...
				'Cosmetic Tools' => [
					'Makeup Tools'    => [
						...
						'Makeup Brushes',
						'Makeup Sponges',
						'Refillable Makeup Palettes & Cases'
					],
					'Nail Tools'      => [
						'Cuticle Pushers',
						'Cuticle Scissors',
						'Manicure & Pedicure Spacers',
						'Manicure Tool Sets',
						'Nail Buffers',
						'Nail Clippers',
					...
					'Skin Care Tools' => [
						...
						'Skin Cleansing Brushes & Systems'
					]
				],
				'Makeup'         => [
					'Body Makeup' => [
			...
			'Cotton Balls',
			'Cotton Swabs',
			'Deodorant & Anti-Perspirant' => [ 'Anti-Perspirant', 'Deodorant' ],
			'Ear Care'                    => [
				'Ear Candles',
				'Ear Drops',
				'Ear Dryers',
			...
			'Shaving & Grooming'          => [
				...
				'Hair Removal' => [
					...
					'Laser & IPL Hair Removal Devices',
			...
			'Vision Care'                 => [
				...
				'Eyewear Accessories' => [
					...
					'Eyewear Replacement Parts',
					'Eyewear Straps & Chains'
				],
				'Sunglass Lenses'
			]
		]
	...
	'Home & Garden'             => [
		...
		'Decor'                              => [
			...
			'Backrest Pillows',
			'Baskets',
			'Bird & Wildlife Feeder Accessories',
			'Bird & Wildlife Feeders'        => [
				'Bird Feeders',
				'Butterfly Feeders',
				'Squirrel Feeders'
			],
			'Bird & Wildlife House Accessories',
			...
			'Throw Pillows',
			'Trunks',
			'Vase Fillers & Table Scatters',
			'Vases',
			'Wallpaper',
			'Weather Vanes & Roof Decor',
			'Wind Chimes',
		...
		'Flood, Fire & Gas Safety'           => [
			...
			'Fire Alarms',
			'Fire Extinguisher & Equipment Storage',
			'Fire Extinguishers',
			'Fire Sprinklers',
			'Heat Detectors',
		...
		'Household Appliance Accessories'    => [
			...
			'Air Purifier Accessories'      => [ 'Air Purifier Filters' ],
			'Dehumidifier Accessories',
			'Fan Accessories',
			'Floor & Steam Cleaner Accessories',
			'Furnace & Boiler Accessories',
			'Heating Radiator Accessories'  => [ 'Heating Radiator Reflectors' ],
			'Humidifier Accessories'        => [ 'Humidifier Filters' ],
			...
			'Patio Heater Accessories'      => [ 'Patio Heater Covers' ],
			'Vacuum Accessories',
		...
		'Household Supplies'                 => [
			...
			'Household Cleaning Supplies'   => [
				...
				'Dusters',
				'Dustpans',
				'Fabric & Upholstery Protectors',
				'Household Cleaning Products' => [
					'All-Purpose Cleaners',
					'Carpet Cleaners',
					'Descalers & Decalcifiers',
					'Dish Detergent & Soap',
					'Dishwasher Cleaners',
			...
			'Laundry Supplies'              => [
				...
				'Garment Shields',
				'Iron Rests',
				'Ironing Board Pads & Covers',
				'Ironing Board Replacement Parts',
				'Ironing Boards',
				'Laundry Balls',
				'Laundry Baskets',
				'Laundry Detergent',
				'Laundry Wash Bags & Frames',
				'Lint Rollers',
				'Wrinkle Releasers & Anti-Static Sprays'
			],
			'Moisture Absorbers',
			'Pest Control'                  => [
				'Fly Swatters',
			...
			'Shoe Care & Tools'             => [
				...
				'Shoe Care Kits',
				'Shoe Dryers',
				'Shoe Horns & Dressing Aids',
				'Shoe Polishers',
				'Shoe Polishes & Waxes',
				'Shoe Scrapers',
				'Shoe Treatments & Dyes',
				'Shoe Trees & Shapers'
			],
			'Stair Treads',
			'Storage & Organization'        => [
				'Clothing & Closet Storage' => [
					'Charging Valets',
					'Closet Organizers & Garment Racks',
					'Clothes Valets',
					'Hangers',
					'Hat Boxes',
		...
		'Kitchen & Dining'                   => [
			'Barware'                       => [
				...
				'Beverage Chilling Cubes & Sticks',
				'Beverage Tubs & Chillers',
				'Bottle Caps',
			...
			'Cookware & Bakeware'           => [
				...
				'Cookware & Bakeware Combo Sets',
				'Cookware Accessories' => [
					'Pot & Pan Handles',
					'Pot & Pan Lids',
					'Pressure Cooker & Canner Accessories',
					'Steamer Baskets',
					'Wok Accessories' => [
						'Wok Brushes',
						'Wok Rings'
			...
			'Kitchen Appliance Accessories' => [
				...
				'Electric Skillet & Wok Accessories',
				...
				'Ice Cream Maker Accessories'                 => [ 'Ice Cream Maker Freezer Bowls' ],
				'Ice Crusher & Shaver Accessories',
				...
				'Water Cooler Accessories'                    => [ 'Water Cooler Bottles' ],
			...
			'Kitchen Appliances'            => [
				...
				'Coffee Makers & Espresso Machines' => [
					'Drip Coffee Makers',
					'Electric & Stovetop Espresso Pots',
					'Espresso Machines',
					'French Presses',
					'Percolators',
			...
			'Kitchen Tools & Utensils'      => [
				...
				'Dough Wheels',
				'Electric Knife Accessories' => [ 'Electric Knife Replacement Blades' ],
				'Electric Knives',
				'Flour Sifters',
				'Food & Drink Stencils',
				'Food Crackers'              => [
					'Lobster & Crab Crackers',
					'Nutcrackers' => [ 'Decorative Nutcrackers' ]
				],
				'Food Dispensers',
				...
				'Kitchen Organizers'         => [
					...
					'Kitchen Counter & Beverage Station Organizers',
					'Kitchen Utensil Holders & Racks',
					'Knife Blocks & Holders',
					'Napkin Holders & Dispensers',
					'Paper Towel Holders & Dispensers',
					'Pot Racks',
					'Spice Organizers',
					'Straw Holders & Dispensers',
					'Sugar Caddies',
					'Toothpick Holders & Dispensers',
					'Utensil & Flatware Trays'
				],
				'Kitchen Scrapers'           => [
					'Bench Scrapers',
					'Bowl Scrapers',
		...
		'Lawn & Garden'                      => [
			'Gardening'                           => [
				'Composting'                   => [ 'Compost', 'Compost Aerators', 'Composters' ],
				'Disease Control',
				'Fertilizers',
			...
			'Outdoor Living'                      => [
				...
				'Outdoor Structures'                      => [
					'Canopies & Gazebos',
					'Canopy & Gazebo Accessories' => [
						'Canopy & Gazebo Enclosure Kits',
						'Canopy & Gazebo Frames',
						'Canopy & Gazebo Tops',
						'Canopy Poles',
						'Canopy Weights'
					],
					'Garden Arches, Trellises, Arbors & Pergolas',
					'Garden Bridges',
					'Sheds, Garages & Carports'
				],
				'Outdoor Umbrella & Sunshade Accessories' => [
					'Outdoor Umbrella & Sunshade Fabric',
			...
			'Outdoor Power Equipment Accessories' => [
				...
				'Weed Trimmer Accessories'                          => [
					'Weed Trimmer Blades & Spools',
					'Weed Trimmer Spool Covers'
				]
			],
			'Snow Removal'                        => [ 'Ice Scrapers & Snow Brushes', 'Snow Shovels' ],
			'Watering & Irrigation'               => [
				'Garden Hose Fittings & Valves',
	...
	'Luggage & Bags'            => [
		...
		'Garment Bags',
		'Luggage Accessories' => [
			'Dry Box Liners & Inserts',
			'Luggage Covers',
			'Luggage Racks & Stands',
			'Luggage Straps',
			'Luggage Tags',
			'Packing Organizers',
	...
	'Mature'                    => [
		...
		'Weapons' => [
			...
			'Gun Care & Accessories' => [
				...
				'Gun Rails',
				'Gun Slings',
				'Reloading Supplies & Equipment' => [ 'Ammunition Reloading Presses' ]
			],
			'Guns',
			'Mace & Pepper Spray',
			'Nunchucks',
	...
	'Media'                     => [
		...
		'Carpentry & Woodworking Project Plans',
		'DVDs & Videos'            => [
			'Film & Television DVDs',
			'Film & Television Digital Downloads',
			'Film & Television VHS Tapes'
		],
		...
		'Product Manuals'          => [
			'Camera & Optics Manuals',
			'Electronics Manuals',
			'Exercise & Fitness Equipment Manuals',
			'Household Appliance Manuals',
			'Kitchen Appliance Manuals',
			'Model & Toys Manuals',
			'Office Supply Manuals',
			'Power Tool & Equipment Manuals',
	...
	'Office Supplies'           => [
		...
		'Filing & Organization'   => [
			...
			'Binding Supplies'        => [
				...
				'Binders',
				'Binding Combs & Spines',
				'Binding Machines'
			],
			'Business Card Books',
			'Business Card Stands',
			'CD/DVD Cases & Organizers',
			...
			'Mail Sorters',
			'Pen & Pencil Cases',
			'Portfolios & Padfolios'  => [ 'Padfolios', 'Portfolios' ],
			'Recipe Card Boxes'
		],
		'General Office Supplies' => [
			...
			'Labels & Tags'                   => [
				...
				'Folder Tabs',
				'Label Clips',
				'Label Tapes & Refill Rolls',
				'Shipping Labels',
				'Shipping Tags'
			],
			'Laminating Film, Pouches & Sheets',
			'Mounting Putty',
			'Office Tape',
			'Paper Clips & Clamps'            => [
				'Binder Clips',
			...
			'Paper Products'                  => [
				...
				'Receipt & Adding Machine Paper Rolls',
				'Stationery',
				'Sticky Notes'
			],
			'Rubber Bands',
		...
		'Lap Desks',
		'Name Plates',
		'Office & Chair Mats'     => [ 'Anti-Fatigue Mats', 'Chair Mats', 'Office Mats' ],
		'Office Carts'            => [
			'AV Carts',
			'Book Carts',
			'File Carts',
		...
		'Office Equipment'        => [
			...
			'Transcribers & Dictation Systems',
			'Typewriters'
		],
		'Office Instruments'      => [
			'Call Bells',
			...
			'Staplers',
			'Tape Dispensers',
			'Writing & Drawing Instrument Accessories' => [
				'Marker & Highlighter Ink Refills' => [
					'Highlighter Refills',
					'Marker Refills'
				],
				'Pen Ink & Refills',
	...
	'Religious & Ceremonial'    => [
		'Memorial Ceremony Supplies' => [ 'Memorial Urns' ],
		'Religious Items'            => [
			'Prayer Beads',
			'Prayer Cards',
			'Religious Altars',
	...
	'Software'                  => [
		...
		'Digital Goods & Currency' => [
			...
			'Document Templates',
			'Fonts',
			'Stock Photographs & Video Footage',
			'Virtual Currency'
		],
		'Video Game Software'
	],
	'Sporting Goods'            => [
		'Athletics'          => [
			...
			'Basketball'                         => [
				'Basketball Hoop Parts & Accessories' => [
			...
			'Boxing & Martial Arts'              => [
				'Boxing & Martial Arts Protective Gear'    => [
					'Boxing & MMA Hand Wraps',
					'Boxing & Martial Arts Arm Guards',
					'Boxing & Martial Arts Body Protectors',
					'Boxing & Martial Arts Headgear',
					'Boxing Gloves & Mitts',
					'MMA Shin Guards'
				],
				'Boxing & Martial Arts Training Equipment' => [
					'Boxing & MMA Punch Mitts',
					'Grappling Dummies',
					'Punching & Training Bag Accessories',
			...
			'Broomball Equipment',
			'Cheerleading'                       => [ 'Cheerleading Pom Poms' ],
			'Coaching & Officiating'             => [
				'Captains Armbands',
				'Field & Court Boundary Markers',
				'Flip Coins & Discs',
				'Linesman Flags',
				'Penalty Cards & Flags',
				'Pitch Counters',
				...
				'Referee Wallets',
				'Scoreboards',
				'Sport & Safety Whistles',
				'Umpire Indicators'
			],
			'Cricket'                            => [
				'Cricket Balls',
				'Cricket Bat Accessories' => [ 'Cricket Bat Grips' ],
				'Cricket Bats',
			...
			'Dancing'                            => [ 'Ballet Barres' ],
			'Fencing'                            => [
				'Fencing Protective Gear' => [
					'Fencing Gloves & Cuffs',
					'Fencing Jackets & Lamés',
					'Fencing Masks'
				],
				'Fencing Weapons'
			],
			'Field Hockey & Lacrosse'            => [
				'Field Hockey & Lacrosse Protective Gear' => [
					'Field Hockey & Lacrosse Gloves',
					'Field Hockey & Lacrosse Helmets',
					'Field Hockey & Lacrosse Masks & Goggles',
					'Field Hockey & Lacrosse Pads'
				],
				'Field Hockey Balls',
				'Field Hockey Goals',
				'Field Hockey Sticks',
			...
			'Figure Skating & Hockey'            => [
				...
				'Hockey Protective Gear'        => [
					...
					'Hockey Helmets',
					'Hockey Pants',
					'Hockey Shin Guards & Leg Pads',
					'Hockey Shoulder Pads & Chest Protectors',
					'Hockey Suspenders & Belts'
				],
				'Hockey Sledges',
				'Hockey Stick Care',
				'Hockey Stick Parts'            => [
			...
			'Football'                           => [
				...
				'Football Protective Gear'    => [
					...
					'Football Helmets',
					'Football Neck Rolls',
					'Football Rib Protection Shirts & Vests',
					'Football Shoulder Pads'
				],
				'Football Training Equipment' => [ 'Football Dummies & Sleds' ],
				'Footballs'
			],
			'General Purpose Athletic Equipment' => [
				'Altitude Training Masks',
				'Athletic Cups',
				'Ball Carrying Bags & Carts',
				'Ball Pump Accessories' => [ 'Ball Pump Needles' ],
				'Ball Pumps',
				'Exercise & Gym Mat Storage Racks & Carts',
				'Grip Spray & Chalk',
				'Gym Mats',
				'Practice Nets & Screens',
				'Speed & Agility Ladders & Hurdles',
				'Sports & Agility Cones',
				'Sports Megaphones',
				'Sports Mouthguards',
			...
			'Gymnastics'                         => [
				...
				'Gymnastics Protective Gear' => [ 'Gymnastics Grips' ],
				'Gymnastics Rings',
			...
			'Racquetball & Squash'               => [
				'Racquetball & Squash Balls',
				'Racquetball & Squash Eyewear',
				'Racquetball & Squash Gloves',
				'Racquetball Racquets',
				'Squash Racquets'
			],
			'Rounders'                           => [ 'Rounders Bats', 'Rounders Gloves' ],
			'Rugby'                              => [
				'Rugby Balls',
				'Rugby Gloves',
				'Rugby Posts',
				'Rugby Protective Gear' => [ 'Rugby Headgear' ],
				'Rugby Training Aids'
			],
			'Soccer'                             => [
				'Soccer Balls',
				...
				'Soccer Goals',
				'Soccer Protective Gear' => [ 'Soccer Shin Guards' ]
			],
			'Team Handball'                      => [ 'Handballs' ],
			'Tennis'                             => [
			...
			'Volleyball'                         => [
				'Volleyball Nets',
				'Volleyball Protective Gear' => [ 'Volleyball Knee Pads' ],
		...
		'Exercise & Fitness' => [
			...
			'Cardio'                  => [
				'Cardio Machine Accessories' => [
					...
					'Stair Climber & Stepper Accessories',
			...
			'Exercise Wedges',
			'Foam Roller Accessories' => [ 'Foam Roller Storage Bags' ],
			'Foam Rollers',
			'Hand Exercisers',
			'Inversion Tables & Systems',
			'Medicine Balls',
			'Power Towers',
		...
		'Indoor Games'       => [
			...
			'Ping Pong'          => [
				'Ping Pong Balls',
				'Ping Pong Nets & Posts',
				'Ping Pong Paddle Accessories',
				'Ping Pong Paddles & Sets',
		...
		'Outdoor Recreation' => [
			'Boating & Water Sports'     => [
				...
				'Kitesurfing'                   => [
					...
					'Kiteboard Parts',
					'Kiteboards',
					'Kitesurfing & Windsurfing Harnesses',
					'Kitesurfing Kites'
				],
				'Surfing'                       => [
					'Bodyboards',
			...
			'Camping & Hiking'           => [
				'Camp Furniture'             => [
					'Air Mattress & Sleeping Pad Accessories',
					'Air Mattresses',
					'Cots'
				],
			...
			'Climbing'                   => [
				'Belay Devices',
				'Carabiners',
				'Climbing Apparel & Accessories' => [
					'Climbing Gloves',
					'Climbing Helmets',
					'Crampons'
				],
				'Climbing Ascenders & Descenders',
				'Climbing Chalk Bags',
				'Climbing Crash Pads',
				'Climbing Harnesses',
			...
			'Hang Gliding & Skydiving'   => [ 'Air Suits', 'Hang Gliders', 'Parachutes' ],
			'Hunting & Shooting'         => [
				'Archery'                            => [
					'Archery Armguards',
					'Archery Gloves & Releases',
					'Archery Targets',
				...
				'Clay Pigeon Shooting'               => [ 'Clay Pigeon Throwers', 'Clay Pigeons' ],
				'Hunting'                            => [
					'Animal Traps',
					'Hearing Enhancers',
					'Hunting Blinds & Screens',
					'Hunting Dog Equipment',
					'Tree Stands',
					'Wild Game Feeders',
					'Wildlife Attractants' => [
						'Cover Scents & Scent Attractants',
						'Hunting & Wildlife Calls',
						'Hunting & Wildlife Decoys',
						'Wildlife Bait, Feed & Minerals'
					]
				],
				'Hunting & Shooting Protective Gear' => [
					'Hunting & Shooting Gloves',
					'Hunting & Shooting Jackets'
				],
				'Paintball & Airsoft'                => [
					'Airsoft'                             => [
						'Airsoft Gun Parts & Accessories' => [ 'Airsoft Gun Batteries' ],
						'Airsoft Guns',
						'Airsoft Pellets'
					],
					'Paintball'                           => [
						...
						'Paintball Grenades',
						'Paintball Gun Parts & Accessories' => [
							'Paintball Air Tanks',
						...
						'Paintball Guns',
						'Paintball Harnesses & Packs',
						'Paintballs'
					],
					'Paintball & Airsoft Protective Gear' => [
						'Paintball & Airsoft Gloves',
						'Paintball & Airsoft Goggles & Masks',
						'Paintball & Airsoft Pads',
						'Paintball & Airsoft Vests'
					]
				],
			...
			'Inline & Roller Skating'    => [
				'Inline & Roller Skating Protective Gear' => [ 'Roller Skating Pads' ],
				'Inline Skate Parts',
				'Inline Skates',
				'Roller Skate Parts',
				'Roller Skates',
			...
			'Kite Buggying'              => [ 'Kite Buggies', 'Kite Buggy Accessories' ],
			'Outdoor Games'              => [
				'Badminton'                => [
					'Badminton Nets',
					'Badminton Racquets & Sets',
					'Shuttlecocks'
				],
				'Deck Shuffleboard'        => [
				...
				'Platform & Paddle Tennis' => [
					'Platform & Paddle Tennis Paddles',
			...
			'Winter Sports & Activities' => [
				...
				'Skiing & Snowboarding' => [
					'Ski & Snowboard Bags',
					'Ski & Snowboard Goggle Accessories' => [ 'Ski & Snowboard Goggle Lenses' ],
					'Ski & Snowboard Goggles',
					'Ski & Snowboard Helmets',
					'Ski & Snowboard Leashes',
					'Ski & Snowboard Storage Racks',
	...
	'Toys & Games'              => [
		...
		'Games'                  => [
			...
			'Dexterity Games',
			'Dice Sets & Games',
			'Poker Chip Accessories' => [ 'Poker Chip Carriers & Trays' ],
			'Poker Chips & Sets',
		...
		'Toys'                   => [
			...
			'Art & Drawing Toys'            => [ 'Play Dough & Putty', 'Toy Drawing Tablets' ],
			'Ball Pit Accessories'          => [ 'Ball Pit Balls' ],
			'Ball Pits',
			'Bath Toys',
			'Beach & Sand Toys',
			'Building Toys'                 => [
			...
			'Executive Toys'                => [ 'Magnet Toys' ],
			'Flying Toy Accessories'        => [ 'Kite Accessories' => [ 'Kite Line Reels & Winders' ] ],
			'Flying Toys'                   => [
				'Air & Water Rockets',
				'Kites',
				'Toy Gliders',
			...
			'Play Vehicle Accessories'      => [
				'Toy Race Car & Track Accessories',
			...
			'Remote Control Toys'           => [
				'Remote Control Airships & Blimps',
				'Remote Control Boats & Watercraft',
			...
			'Robotic Toys',
			'Sports Toy Accessories'        => [ 'Fitness Toy Accessories' => [ 'Hula Hoop Accessories' ] ],
			'Sports Toys'                   => [
				'Baseball Toys',
				'Basketball Toys',
				'Boomerangs',
				'Bowling Toys',
				'Fingerboards & Fingerboard Sets',
				'Fishing Toys',
				'Fitness Toys' => [ 'Hula Hoops' ],
				'Flying Discs',
				'Footbags',
				'Golf Toys',
				'Hockey Toys',
			...
			'Toy Weapons & Gadgets',
			'Visual Toys'                   => [ 'Kaleidoscopes', 'Prisms' ],
			'Wind-Up Toys'
		]
	],
	'Vehicles & Parts'          => [
		'Vehicle Parts & Accessories' => [
			...
			'Motor Vehicle Parts'               => [
				...
				'Motor Vehicle Carpet & Upholstery',
				...
				'Motor Vehicle Power & Electrical Systems',
				...
				'Motor Vehicle Wheel Systems' => [
					'Motor Vehicle Rims & Wheels' => [
						'Automotive Rims & Wheels',
						'Motorcycle Rims & Wheels',
						'Off-Road and All-Terrain Vehicle Rims & Wheels'
					],
			...
			'Vehicle Maintenance, Care & Decor' => [
				...
				'Vehicle Repair & Specialty Tools' => [
					'Motor Vehicle Brake Service Kits',
					'Motor Vehicle Clutch Alignment & Removal Tools',
					...
					'Vehicle Tire Repair & Tire Changing Tools',
			...
			'Vehicle Safety & Security'         => [
				...
				'Off-Road & All-Terrain Vehicle Protective Gear' => [ 'ATV & UTV Bar Pads' ],
				'Vehicle Alarms & Locks'                         => [
					'Automotive Alarm Accessories',
					'Automotive Alarm Systems',
					'Motorcycle Alarms & Locks',
					'Vehicle Door Locks & Parts' => [
						'Vehicle Door Lock Actuators',
						'Vehicle Door Lock Knobs',
						'Vehicle Door Locks & Locking Systems'
					],
					'Vehicle Hitch Locks',
			...
			'Vehicle Storage & Cargo'           => [
				...
				'Motor Vehicle Carrying Rack Accessories' => [
					...
					'Vehicle Ski & Snowboard Rack Accessories'
				],
				'Motor Vehicle Carrying Racks'            => [
					...
					'Vehicle Gun Racks',
					'Vehicle Motorcycle & Scooter Racks',
					'Vehicle Ski & Snowboard Racks',
				...
				'Vehicle Headrest Hangers & Hooks',
				'Vehicle Organizers'
			],
			'Watercraft Parts & Accessories'    => [
				...
				'Sailboat Parts',
				'Watercraft Care'           => [ 'Watercraft Cleaners', 'Watercraft Polishes' ],
				'Watercraft Engine Parts'   => [
					'Watercraft Alternators',
					'Watercraft Carburetors & Parts',
				...
				'Watercraft Exhaust Parts'  => [ 'Watercraft Manifolds', 'Watercraft Mufflers & Parts' ],
				'Watercraft Fuel Systems'   => [
					'Watercraft Fuel Lines & Parts',
					'Watercraft Fuel Meters',
					'Watercraft Fuel Pumps & Parts',
